...
MYSQL_PASSWORD = os.environ.get("MYSQLPASSWORD") or os.environ.get("MYSQL_ROOT_PASSWORD") or os.environ.get("MYSQL_PASSWORD") or ""
...
def debug_db():
    info = {
        ...
        "env_has_mysqlhost": bool(os.environ.get("MYSQLHOST")),
        "env_has_mysqlurl": bool(os.environ.get("MYSQL_URL")),
        "tables": [],
        "counts": {},
        "columns": {},
        "connection": "unknown"
...
def internal_error(e):
    return jsonify({
        "status": "error",
        "message": "服务器内部错误，请查看 Railway Logs 或 Flask 控制台"
    }), 500
